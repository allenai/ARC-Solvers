...
def update_params(params: Params, update_dict:Dict[str, Any], update_if_exists = False):
    """
    Updates params values given an update dictionary
    :param params: Params values to update
    :param update_dict:  The dictionary to update. This is a flat dictionary. If you want to update fields in a hierarchy use ``{"level1->leval2" : "my_new_value"}''
    :param update_if_exists: If this is True, the field is only updated if it exists in the params tree. Otherwise, the field/hierarchy is created.
    :return: Updated version of the params
    """
